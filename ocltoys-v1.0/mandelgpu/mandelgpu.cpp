...
protected:
	...
	virtual void DisplayCallBack() {
	    ...
	    if(pixels) {
	        glTexSubImage2D(TextureTarget, 0, 0, 0, windowWidth, windowHeight, TextureFormat, TextureType, pixels);
	    }
...
private:
	...
	void PrintHelp() {
		...
		fontOffset -= 17;
		PrintHelpString(60, fontOffset, "+ / 1", "increase the max. iterations by 32");
		fontOffset -= 17;
		PrintHelpString(60, fontOffset, "- / 0", "decrease the max. iterations by 32");
		fontOffset -= 17;
