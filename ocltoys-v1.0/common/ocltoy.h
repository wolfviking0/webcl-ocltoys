...
#define OCLTOY_LOG(a) { std::stringstream _OCLTOY_LOG_LOCAL_SS; _OCLTOY_LOG_LOCAL_SS << a; OCLToyDebugHandler(_OCLTOY_LOG_LOCAL_SS.str().c_str()); printf("%s\n",_OCLTOY_LOG_LOCAL_SS.str().c_str()); }
...
protected:
	...
	bool useIdleCallback, printHelp, printCaption;
